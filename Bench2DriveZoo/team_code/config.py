...
class GlobalConfig:
  ...
  def __init__(self):
    ...
    self.static_obstacle_radius = 64.0
    ...
    # IDM minimum distance for static
    self.idm_static_minimum_distance = 4.0
    # IDM desrired time headway for static
    self.idm_static_desired_time_headway = 0.1
    ...
    self.bev_classes_list = [
      ...
      [231, 255, 204],  # road
      [255, 255, 255],  # sidewalk
      [255, 214, 153],  # road line
      [255, 214, 153],  # road line broken
      [255, 69, 0],  # stop sign
      [0, 255, 127],  # light green
      [255, 215, 0],  # light yellow 
      [255, 99, 71],  # light red
      [179, 224, 255],  # vehicle
      [194, 194, 214],  # pedestrian 
    ]
    ...
    self.Other_ACTORS_CLASSES = {0, 4, 5}
    # -----------------------------------------------------------------------------
    # MRP
    # -----------------------------------------------------------------------------
    self.STOP_THRESHOLD_SPEED = 0.1
    self.MAX_STOP_FRAMES = 200  
    self.recovery_throttle_max = 10 
    self.dangerous_time = 1.01
