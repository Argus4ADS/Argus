...
class ObsManager(ObsManagerBase):
    ...
    def get_road(self):
        ...
        try:
            ...
            # print("[WARN] get_road: warpAffine failed, returning empty road image.")
            # print(e)
            # Return an empty mask image
            road_mask = np.zeros((self._width, self._width), dtype=bool)
            lane_mask_all = np.zeros_like(road_mask)
            lane_mask_broken = np.zeros_like(road_mask)
